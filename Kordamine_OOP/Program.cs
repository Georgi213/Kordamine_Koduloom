...
Koer koer = new Koer(Koer.toug.Taksa, "Sarik", "hall", Koduloom.sugu.isane, 35.5, 7, true);
Koer bobik = new Koer(Koer.toug.Mastif, "Praim", "Must", Koduloom.sugu.isane, 50.7, 2, true);
koer.print_Info();
koer.print_Haal();
...
Kass kass = new Kass(Kass.toug.Sfinks, "Murka", "Must", Koduloom.sugu.isane, 25, 1, true);
kass.print_Info();
kass.print_Haal();
